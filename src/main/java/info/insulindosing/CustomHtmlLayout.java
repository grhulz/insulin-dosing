...
public final class CustomHtmlLayout extends AbstractStringLayout {
    ...
    private CustomHtmlLayout(final boolean locationInfo, final String title, final String contentType, final Charset charset, final String font, final String fontSize, final String headerSize) {
        super(charset);
    ...
    public String toSerializable(final LogEvent event) {
        ...
        sbuf.append("<td>");
        //sbuf.append(event.getTimeMillis() - jvmStartTime); Changing this to show the datetimestamp grh 10-10-17
        sbuf.append(LocalDateTime.now().format(DateTimeFormatter.ISO_DATE_TIME));
    ...
    public byte[] getFooter() {
        final StringBuilder sbuf = new StringBuilder();
        //Removing the footer so the html file doesn't break when you stop and start the service grh 10-10-17
        //appendLs(sbuf, "</table>");
        //appendLs(sbuf, "<br>");
